...
ARCHITECTURE behave OF regfile IS
	...
	SIGNAL registerfile : StorageT 
	        := (x"00000000",x"00000002",x"00000003", others=>x"00000000"); -- reg file contents
BEGIN
	...
	BEGIN
		IF rst_n = '0' THEN
			...
			registerfile(2) <= x"00000002";
			registerfile(3) <= x"00000003";
			registerfile(4) <= x"00000004";
			registerfile(5) <= x"00000005";
