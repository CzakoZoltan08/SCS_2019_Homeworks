...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {empty[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {empty[0]}]
#set_property PACKAGE_PIN E19 [get_ports {full[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {full[1]}]
...
set_property PACKAGE_PIN U16 [get_ports {full_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {full_out}]
	
set_property PACKAGE_PIN E19 [get_ports {empty_out}]					
